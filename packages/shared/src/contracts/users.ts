...
export const UpdateUserBodySchema = Type.Object(
  {
    ...
    pronouns: Type.Optional(
      Type.Union([Type.String({ maxLength: 32 }), Type.Null()]),
    ),
...
export const UpdateUserSettingsBodySchema = Type.Partial(UserSettingsSchema, {
  $id: 'UpdateUserSettingsBody',
