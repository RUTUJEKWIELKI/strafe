...
export const CreateBotBodySchema = Type.Object(
  {
    ...
    handle: Type.String({ maxLength: 32, minLength: 3, pattern: '^[A-Za-z0-9_.]+$' }),
    name: Type.String({ maxLength: 64, minLength: 1 }),
    scopes: Type.Array(BotScopeSchema, { maxItems: 4, minItems: 1, uniqueItems: true }),
  },
...
export const BotCredentialSchema = Type.Object({
  ...
  token: Type.String({ description: 'Shown once. Store this credential securely.' }),
})

export const BotListResponseSchema = Type.Object({ bots: Type.Array(BotApplicationSchema) })
